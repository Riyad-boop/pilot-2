...
import os
from protected_areas.wdpa_preprocessor import WDPA_Preprocessor
...
def check_file_exists(filePath:str):
    ...
    if os.path.exists(filePath):
        print("[green]  File found! [/green] :thumbsup:")
    else:
...
def process_wdpa(
    config_path: Annotated[str, typer.Option(..., help="Path to the configuration file")] = "./config.yaml",
    ...
    Example usage: python main.py process-wdpa --config-path ./config.yaml --yes
