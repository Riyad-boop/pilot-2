...
class Impedance_processor():
    ...
    def calculate_edge_effect(self, proximity_data: np.ndarray):
        """
        To be run after config_impdance is validated and proximity data is computed
        """
    ...
    def update_impedance_with_decay(self):
        """
        To be run after all stressors have been processed
        """
