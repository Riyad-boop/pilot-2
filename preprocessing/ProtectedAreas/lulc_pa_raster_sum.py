...
class Lulc_pa_raster_sum():
    ...
    def __init__(self, 
        ...
        """
        self.lulc_path = self.make_directory_if_not_exists(lulc_path)
        self.lulc_with_null_path = self.make_directory_if_not_exists(lulc_with_null_path)
        self.lulc_upd_compr_path = self.make_directory_if_not_exists(lulc_upd_compr_path)
...
#         os.chdir('./preprocessing/1_protected_areas')
#     lprs = Lulc_pa_raster_sum()
