import os
import subprocess
from protected_areas.pa_processor import PA_Processor
import requests
...
class PA_Processor_Wrapper:
    ...
    def process_all_countries(self) -> None:
        """
        Fetches all PAs for each country and processes them into a GeoJSON file per country in memory.
        """
    ...
    def save_all_country_geoJSON(self) -> list[str]:
        """
        Saves all country GeoJSON files in memory to the export directory.
